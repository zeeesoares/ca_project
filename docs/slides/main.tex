...
\begin{frame}{Context \& Problem}
    ...
    \begin{itemize}
        ...
        \item \textbf{Consequence:} Compute nodes stall while waiting for slow synchronous writes, wasting expensive resources.
    \end{itemize}
...
\begin{frame}{Results: Throughput Profiles}
    ...
    \end{columns}
\end{frame}
\subsection{Bandwidth Convergence}
...
\begin{frame}{Conclusions \& Future Work}
    ...
    \begin{itemize}
        ...
        \item Local SSD staging is a scalable option to absorb bursty I/O patterns.
    \end{itemize}
